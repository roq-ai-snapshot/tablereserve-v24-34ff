...
function HomePage() {
  return (
    <>
      <Head>
        <title>TableReserve v24</title>

        <meta
          name="description"
          content="Discover TableReserve v24: Revolutionizing the Dining Experience with Streamlined Table Bookings, Personalized Customer Preferences, and Optimized Restaurant Occupancy for Unparalleled Efficiency."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Discover TableReserve v24: Revolutionizing the Dining Experience with Streamlined Table Bookings, Personalized Customer Preferences, and Optimized Restaurant Occupancy for Unparalleled Efficiency.`}
            </Text>
